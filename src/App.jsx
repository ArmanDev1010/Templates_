      ...
      >
        <Routes>
          <Route path="/template1/">
            ...
            {/* <Route path="" element={<Home codename="strategy" />} /> */}
          </Route>
          ...
          <Route path="/template5/">
            ...
            {/* <Route path="" element={<Home5 codename="kbuild" />} /> */}
            {/* <Route path="" element={<Home5 codename="mhstud" />} /> */}
            {/* <Route path="" element={<Home5 codename="blanc" />} /> */}
            {/* <Route path="" element={<Home5 codename="danib" />} /> */}
            ...
            {/* <Route path="" element={<Home5 codename="vishnu" />} /> */}
            {/* <Route path="" element={<Home5 codename="baptis" />} /> */}
            {/* <Route path="" element={<Home5 codename="nacrt" />} /> */}
            {/* <Route path="" element={<Home5 codename="b3" />} /> */}
            {/* <Route path="" element={<Home5 codename="stephen" />} /> */}
            {/* <Route path="" element={<Home5 codename="tierone" />} /> */}
            {/* <Route path="" element={<Home5 codename="desshop" />} /> */}
            {/* <Route path="" element={<Home5 codename="studtj" />} /> */}
            {/* <Route path="" element={<Home5 codename="shm" />} /> */}
            {/* <Route path="" element={<Home5 codename="janas" />} /> */}
            {/* <Route path="" element={<Home5 codename="hudson" />} /> */}
            <Route path="" element={<Home5 codename="baring" />} />
          </Route>
        </Routes>
      </MyContext.Provider>
    </div>
